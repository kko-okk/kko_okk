...
struct ButtonForContract: View {
    ...
    // MARK: - 부모와 자식의 Promise Gesture 싱크를 맞추기 위한 타이머 (PromisePair 유효 시간)
    ...
    var body: some View {
        ...
        ZStack {
            HStack{ // 약속 제목 및 내용과 Check버튼의 영역을 분리하기 위한 HStack
                ...
                // MARK: - promised List에서 check 버튼활성화
